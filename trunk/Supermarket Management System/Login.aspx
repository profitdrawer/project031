...
<body style="color: navy; font-family: Arial; background-color: silver; background-image: url(background.jpg);">
    ...
    <div>
        <asp:Label ID="LoginLabel" runat="server" Style="z-index: 100; left: 399px; position: absolute;
            top: 169px" Text="用户登录" Font-Bold="True" Font-Names="Arial Black" Font-Size="X-Large" Height="38px" Width="116px"></asp:Label>
        ...
        <asp:RequiredFieldValidator ID="labError" runat="server" ErrorMessage="用户名或密码错误，无法登录！"
            Style="z-index: 109; left: 567px; position: absolute; top: 217px" ControlToValidate="tbxName" EnableViewState="False" Visible="False"></asp:RequiredFieldValidator>
        <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="You must type a username!"
            Style="z-index: 110; left: 755px; position: absolute; top: 262px" ControlToValidate="tbxName" Width="192px">*</asp:RequiredFieldValidator>
        <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ErrorMessage="You nust specify a password!"
            Style="z-index: 111; left: 755px; position: absolute; top: 355px" ControlToValidate="tbxPassword" Font-Overline="False" Height="1px" Width="205px">*</asp:RequiredFieldValidator>
        <asp:ValidationSummary ID="ValidMessage" runat="server" ShowMessageBox="True"
            ShowSummary="False" Style="z-index: 112; left: 758px; position: absolute; top: 287px" Width="203px" />
        &nbsp;&nbsp;
